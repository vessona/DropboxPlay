...
public class FilesActivity extends DropboxActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilesAdapter = new FilesAdapter(PicassoClient.getPicasso(), new FilesAdapter.Callback() {
            ...
            @Override
            public void onFileLongClick(final FileMetadata file) {
                mSelectedFile = file;
                performWithPermissions(FileAction.DELETE);
            }
    ...
    public void onRequestPermissionsResult(int actionCode, @NonNull String [] permissions, @NonNull int [] grantResults) {
        ...
        if (granted) {
            ...
            switch (action) {
                ...
                case DELETE:
                    Toast.makeText(this,
                            "Can't delete file: write access denied. " +
                                    "Please grant storage permissions to use this functionality.",
                            Toast.LENGTH_LONG)
                            .show();
    ...
    private void performAction(FileAction action) {
        switch(action) {
            ...
            case DELETE:
                if (mSelectedFile != null) {
                    deleteFile(mSelectedFile);
                } else {
                    Log.e(TAG, "No file selected to delete.");
                }
                break;
            default:
    ...
    protected void loadData() {
        ...
        new GetCurrentAccountTask(DropboxClientFactory.getClient(), new GetCurrentAccountTask.Callback() {
            ...
            public void onComplete(FullAccount result) {
                ...
                CircularImageView user_pic = (CircularImageView)findViewById(R.id.user_pic);
                ...
                try{
                    ...
                    String name_json = jsonObject.getString("given_name");
                    tv_name.setText("Hi " + name_json);
                }
                catch (Exception e)
                {
    ...
    private void deleteFile(FileMetadata file) {
        ...
        new DeleteFileTask(FilesActivity.this, DropboxClientFactory.getClient(), new DeleteFileTask.Callback() {
            @Override
            public void onDeleteComplete(File result) {
                dialog.dismiss();
                loadData();
            }
    ...
    private void uploadFile(String fileUri) {
        ...
        new UploadFileTask(this, DropboxClientFactory.getClient(), new UploadFileTask.Callback() {
            ...
            public void onUploadComplete(FileMetadata result) {
                dialog.dismiss();
                String message = result.getName() + " size " + result.getSize() + " uploaded successfully ";
                Snackbar.make(findViewById(R.id.filesLayout), message, Snackbar.LENGTH_LONG)
    ...
    protected void onResume() {
        super.onResume();
        if (!hasToken()) {
            Auth.startOAuth2Authentication(FilesActivity.this, DROPBOX_APP_KEY);
        }
    }
}